...
- **Esprimersi con chiarezza e concisione**. È importante evitare l'uso di gergo tecnico e complesso quando non necessario (oppure spiegarlo chiaramente tramite un glossaio), per far sì che il proprio pubblico comprenda chiaramente la documentazione. Allo stesso modo, è importante mantenere le descrizioni concise, evitando ripetizioni e informazioni superflue: la chiarezza è fondamentale e spiegare i concetti in modo semplice e diretto, evitando ambiguità e confusione, è l'obiettivo da tenere sempre a mente.
