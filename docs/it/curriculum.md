...
10. Lingue e Hobby
    Il 90% dei CV che normalmente i/le recruiter ricevono NON ha la sezione hobby, ed è un peccato! È invece una delle sezioni più interessanti (ed in alcuni casi, divertente) di tutto il CV. Ti permette di farti conoscere come persona, e non solo come tecnico. Fornisce inoltre un sacco di spunti di conversazione utili a carpire ulteriori punti di vista, modi di vedere le cose, obiettivi raggiunti e molto altro.
